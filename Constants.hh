...
static std::map<std::string, TVector3> AREA_NORMALS =
  {
...
__attribute__((unused)) static const char * BRANCH_NAMES[nbranch] =
  {
...
__attribute__((unused)) static const char * DATA_CHECK_BRANCH_NAMES[ndcbranch] =
  {
